    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>Adjust filters or check your assigned caseload.</EmptyDescription>
        </EmptyHeader>
      </Empty>
    );
  return (
    <>
      {stale && (
        <Alert>
          <AlertTitle>Partial or stale data</AlertTitle>
          <AlertDescription>The latest successful refresh is shown. Confirm freshness before acting.</AlertDescription>
        </Alert>
      )}
      {children}
    </>
